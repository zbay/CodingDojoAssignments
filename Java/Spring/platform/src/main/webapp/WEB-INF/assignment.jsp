...
<body style="text-align: center">
	...
	<div class="box">
		<input type="checkbox" name="completed" value="true"/><label for="completed">Assignment completed</label>
		<br />
		<c:out value="${title}"></c:out> placeholder. The goal of the assignment is...
	</div>
</body>
</html>